...
public class StageVisualScript : MonoBehaviour
{
    ...
    public void CreateGridLines(int gridSize)
    {
        ...
        for(int count = 1; count <= totalLineCount; count++)
        {
            ...
            float initialPosition = ((stageLength - padding - padding) / gridSize) * count;
            ...
            verticalLine.transform.localScale = new Vector3(stageLength - (padding * 2), .1f, lineWidth);
            ...
            horizontalLine.transform.localScale = new Vector3(lineWidth, .1f, stageLength - (padding * 2));
        }
    }
